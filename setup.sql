...
INSERT INTO series VALUES (252, 'TV', 'TV Movies');
INSERT INTO series VALUES (253, 'SS', 'Side Stories');
INSERT INTO series VALUES (254, 'PK', 'Pikachu Shorts');
INSERT INTO series VALUES (255, 'M', 'Movies');

DROP TABLE IF EXISTS episodes;
CREATE TABLE episodes (
  code VARCHAR(6) NOT NULL PRIMARY KEY,
  series TINYINT UNSIGNED NULL REFERENCES series (id) ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS dubs (
  code VARCHAR(5) NOT NULL PRIMARY KEY REFERENCES episodes (code) ON DELETE RESTRICT,
  season TINYINT UNSIGNED NULL REFERENCES seasons (id) ON DELETE RESTRICT,
  number SMALLINT UNSIGNED NULL DEFAULT NULL,
  title VARCHAR(128) NOT NULL,
  airdate DATE DEFAULT NULL
) ENGINE InnoDB CHARACTER SET utf8 COLLATE utf8_bin;
